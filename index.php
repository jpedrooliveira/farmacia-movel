...
<head>
	...
	<script src="js/function.js?89"></script>
										...
										if(noteToRecipient != null) {
											...
											if(!noteToRecipient.includes(entrega)) {
												...
												if(yearDeliveryDate == yearTodayDate && monthDeliveryDate == monthTodayDate && dayDeliveryDate == dayTodayDate) {
													...
													var foo3, targetElement3  = document.getElementById('encomendas3');
                                                    foo3 = document.createElement('div');
                                                    foo3.innerHTML ="<ons-modal id='my-modal-pagamento" + nencomenda + "'><div style='text-align: center'><p><iframe id='iframe-pagamento" + nencomenda + "' src='braintree_php_example-master/public_html/index.php' frameBorder='0' height='500' style='width: 70%;'></iframe></p></div></ons-modal>";
                                                    targetElement3.appendChild(foo3);
